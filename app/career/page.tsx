...
export default function CareerPage() {
  ...
  return <>
    ...
    <h1 className="max-w-4xl text-4xl font-bold tracking-tight text-foreground sm:text-6xl">Enterprise UI developer who helps teams turn complex requirements into reliable applications.</h1>
    <p className="mt-6 max-w-3xl text-lg leading-8 text-muted-foreground">I specialize in SAPUI5, SAP Fiori, and SAP BTP application work, with additional enterprise UI experience across Salesforce and modern web platforms. I contribute as a hands-on developer, technical lead, mentor, and bridge between business needs and dependable delivery.</p>
    <p className="mt-4 max-w-3xl text-sm text-muted-foreground">Client identities and selected implementation details have been generalized to protect confidentiality.</p>
    ...
    <section className="mt-20 grid gap-8 rounded-2xl border border-brand-primary/20 bg-brand-soft p-7 md:grid-cols-[1.4fr_1fr] md:p-10"><div><p className="text-sm font-semibold text-brand-primary">BEST-FIT ROLES</p><h2 className="mt-3 text-3xl font-bold">Senior SAPUI5/Fiori developer, SAP BTP application developer, enterprise frontend lead, or enterprise UI technical lead.</h2></div><ul className="space-y-3 text-muted-foreground"><li>✓ Hands-on development and delivery ownership</li><li>✓ Enterprise frontend and application architecture</li><li>✓ Mentoring and cross-team collaboration</li><li>✓ Requirements, documentation, testing, and validation</li></ul></section>
  </>
}
