...
const groups = [
  ["Primary strengths", ["SAPUI5 and SAP Fiori application development", "SAP BTP application development", "SAP CAP service development (Node.js)", "SAP Build Work Zone configuration", "SAP Cloud Identity Services configuration with Okta SSO integration", "Enterprise frontend architecture", "OData and REST API consumption", "JavaScript, HTML, CSS, React, and Next.js"]],
  ...
  ["Additional experience", ["Salesforce Experience Cloud", "Salesforce UI and release support", "Cloud Foundry exposure", "Joule Agents / SAP Build (POC in progress)"]],
]
...
export default function ExperiencePage() {
  return <>
    ...
    <section className="mt-10 rounded-xl border border-brand-primary/20 bg-brand-soft p-6">
      ...
      <p className="mt-3 leading-7 text-muted-foreground">One continuous employer since August 2017. Functional responsibilities progressed by engagement — developer, technical lead, and solution engineering — and are presented here as delivered work.</p>
    </section>
