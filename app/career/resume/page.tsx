...
export default function ResumePage() {
  return <article className="mx-auto max-w-4xl">
    ...
    <section className="py-10"><h2 className="text-2xl font-semibold">Professional summary</h2><p className="mt-4 leading-8 text-muted-foreground">Enterprise UI developer and technical lead with nearly 9 years of experience delivering applications and user experiences in large organizations. Strongest in SAPUI5, SAP Fiori, SAP BTP application development, OData/API consumption, Salesforce UI, requirements translation, technical documentation, mentoring, and cross-team delivery.</p></section>
    ...
    <p className="rounded-lg border border-brand-primary/20 bg-brand-soft p-4 text-sm text-muted-foreground">Contact: hello@cashbryan.com · LinkedIn: linkedin.com/in/cashbryan</p>
  </article>
}
