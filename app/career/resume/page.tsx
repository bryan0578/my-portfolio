...
export default function ResumePage() {
  return <article className="mx-auto max-w-4xl">
    <div className="flex flex-col gap-5 border-b border-border pb-8 sm:flex-row sm:items-end sm:justify-between">
      ...
      <AnalyticsLink href="mailto:hello@cashbryan.com?subject=Resume%20request" event="resume_download_requested" className="rounded-md bg-brand-primary px-5 py-3 text-center font-semibold text-black">Request current PDF resume</AnalyticsLink>
    </div>
