...
export interface Project {
  ...
  export const projects: Record<string, Project> = {
    "manufacturer-portal": {
      ...
      summary: "Developed enterprise reporting applications and supported delivery of a secure SAP BTP experience for external manufacturers.",
      ...
      solution: "Built SAPUI5 reporting experiences and contributed to a solution using SAP Build Work Zone, Node.js CAP services, Datasphere data, and identity-based access controls.",
