...
<ComparisonTable>
  ...
  <tbody>
    <tr>
      ...
      <td>Feature development, spikes, breaking changes</td>
      <td>Long-lived sandboxes that drift from team norms</td>
    </tr>
    <tr>
      <td><strong>QA</strong></td>
      <td>Integrated testing, regression</td>
      <td>Used as personal dev sandboxes</td>
    </tr>
    <tr>
      <td><strong>UAT</strong></td>
      <td>Business acceptance</td>
      <td>Missing prod-like identity/site config</td>
    </tr>
    <tr>
      <td><strong>Prod</strong></td>
      <td>Live users</td>
      <td>Emergency changes without back-promotion plan</td>
    </tr>
  </tbody>
</ComparisonTable>
