...
<ComparisonTable>
  <thead>
    <tr>
      <th>Factor</th>
      <th>SAP BTP consultant</th>
      <th>Systems integrator</th>
  ...
  <tbody>
    <tr>
      <td>Time to start</td>
      <td>Weeks</td>
      <td>Months (procurement)</td>
      <td>Months (recruiting)</td>
    </tr>
    <tr>
      <td>BTP depth</td>
      <td>High if specialist</td>
      <td>Variable by team</td>
      <td>High after ramp</td>
    </tr>
    <tr>
      <td>Identity / portal focus</td>
      <td>Can be primary scope</td>
      <td>Often underweighted</td>
      <td>Depends on role</td>
    </tr>
    <tr>
      <td>Knowledge retention</td>
      <td>Documented handoff</td>
      <td>Vendor-dependent</td>
      <td>Strong</td>
    </tr>
    <tr>
      <td>Best for</td>
      <td>Focused initiative</td>
      <td>Enterprise transform</td>
      <td>Ongoing platform</td>
    </tr>
  </tbody>
</ComparisonTable>
