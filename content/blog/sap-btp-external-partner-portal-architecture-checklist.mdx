...
<ComparisonTable>
  ...
  <tbody>
    <tr>
      <td>Partner pilot cohort identified</td>
      <td />
    </tr>
    <tr>
      <td>Federation tested with real IdP attributes</td>
      <td />
    </tr>
    <tr>
      <td>ABAC negative tests (Partner A cannot see Partner B)</td>
      <td />
    </tr>
    <tr>
      <td>Support model for login and access issues</td>
      <td />
    </tr>
    <tr>
      <td>Rollback plan for portal and services</td>
      <td />
    </tr>
    <tr>
      <td>Adoption metrics defined (not only go-live date)</td>
      <td />
    </tr>
  </tbody>
</ComparisonTable>
